...
const DiscordChannelConfigSchema = buildChannelConfigSchema(DiscordConfigSchema, { uiHints: {
	...
	"voice.model": {
		...
		help: "Optional LLM model override for Discord voice channel responses and realtime agent consults (for example ollama/qwen2.5:3b). Leave unset to inherit the routed agent model."
	},
	"voice.mode": {
